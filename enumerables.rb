...
def get_spicy_food_by_cuisine(spicy_foods, cuisine)
  # your code here
  spice_cuisine = spicy_foods.find {|food| food[:cuisine] == cuisine}
  pp spice_cuisine
end
...
def average_heat_level(spicy_foods)
  # your code here
spicy = spicy_foods.sum {|food| food[:heat_level]}
average = spicy /spicy_foods.length
average.round
end
binding.pry
0